...
Route::group(array('prefix' => 'admin', 'before' => 'auth'), function()
{
    ...
    # Member Management
    // Route::get('members/data', 'AdminMembersController@getData');

    Route::resource('members', 'AdminMembersController');

    Route::post('pages/addimage', 'AdminPagesController@addImage');
    Route::get('pages/deleteimage/{image}', 'AdminPagesController@deleteImage');
...
Route::get('profile', array('before' => 'detectLang','uses' => 'BlogController@getProfile'));
